...
When compared to all Seattle Public Library items checked out at least 10 times a month from 2017-2023, items with Subjects including African American" made up only 0.02%. Of these items, the work with the highest total number of checkouts is "Becoming (Unabridged)® with 16029 checkouts. The three creators whose works have the highest total number of checkouts for these items are Michelle Obama, Michelle Obama, Colson Whitehead, and Ta-Nehisi Coates. These are some of the most well known Black authors who have contributed greatly to literature with works advancing the field of literature and shedding light onto the racial injustice in this country. So far this year, The light we carry: overcoming in uncertain times / Michelle Obama. has the most checkouts of all items whose subject contains "African American". There are hundreds of different items from the Seattle Public Library whose subject contains "African American". The most popular subject, however, is African American Fiction, Fiction, Literature based on total checkouts. Because this research aims to discover patterns among checkouts for these items over the last few years, it was important to calculate the total number of checkouts for each year. The year with the highest number of checkouts was 2019. This was a bit of a surprise considering 2020 saw the rise of the Black Lives Matter movements and other forms of activism against racism. It is also important to note that this was the year that the COVID-19 pandemic began, which may have affected fibrary checkouts.
In total, 2020 had 134609 checkouts for items with subjects containing "African American"
